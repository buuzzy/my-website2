...
![产品经理岗位类型](/img/pm-types_images/image.png)
...
| **产品类型** | **产品业务**    | **能力要求**      | **参考产品**      | **岗位示例(仅供参考❗)**         |
| -------- | ----------- | ------------- | ------------- | ----------------------- |
| 社区       | 社区产品        | 用户体验、用户心理     | 小红书、得物、虎扑、即刻  | ![社区产品经理](/img/pm-types_images/image-1.png) |
| 支付       | 支付产品        | 财税知识、逻辑抽象     | 支付宝、PayPal    | ![支付产品经理](/img/pm-types_images/image-2.png) |
| 搜索       | 搜索产品        | 数据分析、策略规划     | 各大应用内的搜索功能    | ![搜索产品经理](/img/pm-types_images/image-3.png) |
| 财务       | 财务产品        | 财务知识、项目管理     | 金蝶、平安一帐通      | ![财务产品经理](/img/pm-types_images/image-4.png) |
| 商业化      | 商业化产品流量变现产品 | 数据分析、ROI分析、商业 | 巨量引擎、广点通、微信广告 | ![商业化产品经理](/img/pm-types_images/image-5.png) |
...
![产品业务线](/img/pm-types_images/diagram.png)
...
![产品经理职级](/img/pm-types_images/acd1b76ceee4000d1305a6719a4165c6.png)
