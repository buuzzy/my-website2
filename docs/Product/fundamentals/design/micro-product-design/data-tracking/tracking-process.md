...
![01](/img/tracking-process_images/01.png)
...
![02](/img/tracking-process_images/02.png)
...
![03](/img/tracking-process_images/03.png)
...
![04](/img/tracking-process_images/04.png)
...
![05](/img/tracking-process_images/05.png)

2. 券商产品事件（用户行为）：

![06](/img/tracking-process_images/06.png)
...
我想很多产品经理都不会认真思考这个问题，一方面是没有思考的必要，��一方面是埋点方式经常采用直觉去做出选择。判断点击事件的方式也比较简单，就是看这个事件的重要性。一般来说，涉及到核心业务和指标都需要单独设置事件采集。
...
![07](/img/tracking-process_images/07.png)
...
![08](/img/tracking-process_images/08.png)
...
![09](/img/tracking-process_images/09.png)
...
![10](/img/tracking-process_images/10.png)
